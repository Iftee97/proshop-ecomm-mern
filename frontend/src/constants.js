// // dev urls (uncomment when running locally)
...
// // prod urls (comment out when running locally):
...
export const UPLOAD_URL = `${import.meta.env.VITE_APP_PROD_BACKEND_SERVER_BASE_URL}/api/upload`
